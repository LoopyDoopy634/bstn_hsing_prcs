#This script gives a visualization of our multi-feature decision tree model.
...
print("Generating new tree visualization...")
plt.figure(figsize=(20, 10))   #Create a figure of width 20 and height 10.

plot_tree(model, feature_names=['RM', 'LSTAT'], filled=True, rounded=True, fontsize=10)   #Use the model to plot it on the figure.
plt.title("Multi-Feature Decision Tree (RM & LSTAT)", fontsize=16)
output_image_file = 'multi_feature_tree.png'
...
print(f"New tree visualization saved to '{image_path}'")
